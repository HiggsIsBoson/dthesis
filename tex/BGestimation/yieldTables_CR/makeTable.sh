...
dump(){
    ...
    cat ${inFilePath} | grep "MC exp. Tops"      | sed -e "s#MC exp. Tops#Tops#g"                    | cut -d "&" -f 1,3- | tee -a ${outFilePath}
...
dump2(){
    ...
    echo `dump2_Impl ${inFilePath1} ${inFilePath2} "MC exp. Tops"    ` | sed -e "s#MC exp. Tops#Tops#g"         | tee -a ${outFilePath}
