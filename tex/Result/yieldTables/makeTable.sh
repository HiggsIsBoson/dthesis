...
#    cat ${inFilePath} | grep "Fitted objRep"    | sed -e "s#Fitted objRep#Di-leptonic#g"           | tee -a ${outFilePath}    
...
cat yieldTable_[2,6]J.tex yieldTable_Lowx.tex yieldTable_Highx.tex yieldTable_3B.tex > ../tab_SRyields.tex
